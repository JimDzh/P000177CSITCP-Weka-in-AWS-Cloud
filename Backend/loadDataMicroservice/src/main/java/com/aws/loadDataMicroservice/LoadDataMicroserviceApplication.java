...
public class LoadDataMicroserviceApplication {
	...
	public static void main(String[] args) {
		...
		try{
			loader.setSource(new File("./Datasets/testCsvJim.csv"));
		...
		// LOADING A DATASET
		try{
			Instances dataset = new Instances(new BufferedReader(new FileReader("/Users/jim/Desktop/JH-177 CloudWeka/P000177CSITCP-Weka-in-AWS-Cloud/Datasets/resultArff.arff")));

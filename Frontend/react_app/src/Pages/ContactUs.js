    ...
    return(
        <div className="contact">
            <div className="container">
                <form style={{margin: "auto", width: "220px"}} action="">
                    <label>
                        Name
            ...
            <h2 style={{textAlign: "center",marginBottom: "16px"}}>Our Team</h2>
            <div style={{textAlign: "center"}}>
                <div style={{float: "left", width: "20%"}}>
                    <h4>Zhihong Deng</h4>
                    <p>s3860863@student.rmit.edu.au</p>
                </div>

                <div style={{float: "left", width: "20%"}}>
                    <h4>Sai Sreshtaa Turaga</h4>
                    <p>s3814571@student.rmit.edu.au</p>
                </div>

                <div style={{float: "left", width: "20%"}}>
                    <h4>Christoper Adrianus Sindarto</h4>
                    <p>s3738844@student.rmit.edu.au</p>
                </div>

                <div style={{float: "left", width: "20%"}}>
                    <h4>Yitao Ma</h4>
                    <p>s3843689@student.rmit.edu.au</p>
                </div>

                <div style={{float: "left", width: "20%"}}>
                    <h4>Zehu Liu</h4>
                    <p>s3845938@student.rmit.edu.au</p>
                </div>
